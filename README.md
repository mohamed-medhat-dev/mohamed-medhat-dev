...
### Senior Flutter Developer & Technical Team Lead | Architecting Scalable Business Solutions

- 🚀 **Current Focus:** Leading the **BiteNext Ecosystem** (Multi-tier Customer, Admin, and Support platforms).
- 🛠️ **Expertise:** Scalable Architecture, Clean Code (BLoC/Provider), and Performance Optimization.
- 📱 **Mobile Vision:** Building high-performance, cross-platform experiences that drive business growth.
- 🔗 **Backend Mastery:** Advanced Firebase integration (Functions, Firestore, Auth) & Complex REST APIs.
- 🌍 Based in Cairo, Egypt.

---

### 🛠️ Technical Stack & Leadership Tools
